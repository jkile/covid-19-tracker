...
function createDropDown(states) {
  ...
  stateSelector.setAttribute(
    "class",
    "appearance-none w-24 mx-auto bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline"
  );
...
function getStatePositive(data, state) {
  const positiveState = document
    .getElementById("positiveState")
    .getContext("2d");
